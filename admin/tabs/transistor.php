...
function podloom_render_transistor_tab( $api_key, $default_show, $enable_cache, $cache_duration, $connection_status, $shows ) {
	...
	<div class="podloom-settings-card">
		<h3 class="podloom-card-title"><?php esc_html_e( 'API Key', 'podloom-podcast-player' ); ?></h3>
		<p class="description">
			<?php
			printf(
		...
		<form method="post" action="">
			...
			<div class="podloom-api-key-input" style="display: flex; align-items: center; gap: 8px; margin-top: 12px;">
				...
				<?php submit_button( esc_html__( 'Save', 'podloom-podcast-player' ), 'primary', 'podloom_settings_submit', false ); ?>
			</div>
		</form>
	</div>
	...
	<!-- Your Shows Card -->
	<div class="podloom-settings-card">
		<h3 class="podloom-card-title"><?php esc_html_e( 'Your Shows', 'podloom-podcast-player' ); ?></h3>
		<p class="description">
		...
		<table class="wp-list-table widefat fixed striped" style="margin-top: 12px;">
			...
			<tbody>
				...
				<tr>
					...
					<td><code><?php echo esc_html( $show['id'] ); ?></code></td>
					<td>
